...
import { loadSessions, saveSessions, generateId, sessionExists, killSession, getSessionSocketName } from './sessions.mjs';
...
export async function handleRequest(req, res) {
  ...
  if (pathname === '/api/sessions' && req.method === 'POST') {
    ...
    try {
      const { name, folder, tool } = JSON.parse(body);
