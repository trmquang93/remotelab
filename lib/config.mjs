...
export const UPLOADS_DIR = join(configDir, 'uploads');
export const SETTINGS_FILE = join(configDir, 'settings.json');
export const CS_PORT_RANGE_START = validPort(process.env.CS_PORT_RANGE_START, 7800);
export const CS_PORT_RANGE_END = validPort(process.env.CS_PORT_RANGE_END, 7849);
